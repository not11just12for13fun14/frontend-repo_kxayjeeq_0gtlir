    ...
    <header className="fixed top-0 left-0 right-0 z-20 backdrop-blur border-b border-white/10 bg-black/30">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-2 text-white">
          ...
          <span className="font-semibold tracking-wide">My Futurist Portfolio</span>
        </a>
        <nav className="hidden md:flex items-center gap-8 text-sm text-white/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#contact"
              className="flex items-center gap-2 px-3 py-2 rounded-md bg-gradient-to-r from-fuchsia-600 to-indigo-600 text-white shadow-lg shadow-fuchsia-500/20 hover:shadow-fuchsia-500/30 transition"
            >
              <Mail className="h-4 w-4" /> <span className="hidden sm:inline">Say hello</span>
            </a>
          </div>
        </nav>
      </div>
